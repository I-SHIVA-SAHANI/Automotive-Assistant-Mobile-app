...
public class BunkModel {
    String bunkname, bunkavailability, bunkstate, bunkcity, bunkaddress, bunkpinCode, bunkphone, bunklandmark;

    public BunkModel() {
    }

    public BunkModel(String bunkname, String bunkavailability, String bunkstate, String bunkcity, String bunkaddress, String bunkpinCode, String bunkphone, String bunklandmark) {
