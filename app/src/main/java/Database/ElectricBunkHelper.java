...
public class ElectricBunkHelper {

    public String elbname, elavailability, eladdress, elstate, elcity, elpin;

    public ElectricBunkHelper(String elbname, String elavailability, String eladdress, String elstate, String elcity, String elpin) {
